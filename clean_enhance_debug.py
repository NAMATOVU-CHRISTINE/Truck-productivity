#!/usr/bin/env python
"""
Truck Productivity System - Clean, Enhance, and Debug Script (Error-Free Version)
This script cleans data quality issues and enhances the efficiency calculations
"""
import os
import django
import pandas as pd
